...
| REQ-FR-028 financial fraud-ring/cuentas mulas workflow | DEC-016, DEC-024, DEC-034 | financial-fraud module tests, Pages E2E | novice financial workflow and overreliance tests | E, F, G, H, J, L |
| REQ-FR-028 importable financial transactions | DEC-016, DEC-024, DEC-034 | BB-FRAUD-001, BB-FRAUD-007–009, transaction-import tests, Pages E2E | novice financial import workflow and overreliance tests | E, F, G, H, J, L |
| REQ-FR-029 graph manipulation undo/redo/reset | DEC-004, DEC-014, DEC-035 | Pages E2E layout controls | customization/accessibility tests | I, J, L |
| Phase B i2-class chart workspace | DEC-004, DEC-014, DEC-035 | BB-CHART-001–005, chart-workspace module tests, Pages E2E | expert charting and customization tests | I, J, L |
...
| Training MVP web deployment; guided-flow availability | `scripts/build-pages.mjs`, `.github/workflows/pages.yml`, `docs/deployment/github-pages.md` | `tests/browser/pages.e2e.mjs`, `make test-browser-pages`, remote GitHub Actions deployment | Generated artifact passes under `/NetworkAnalyticsPredictivePlatform/`: assets, JSON modules, static-training mode, seven-step journey, and report preflight work without browser errors. Public HTTPS deployment is available at `https://pillb.github.io/NetworkAnalyticsPredictivePlatform/`; operational data remains excluded. |
| REQ-FR-028–029; financial transaction mule/ring workflow and graph manipulation | `packages/guided-workflow/financial-fraud.mjs`, `apps/web/app.mjs`, `packages/graph-renderer/svg-renderer.mjs`, `docs/requirements/financial-fraud-ring-use-case.md`, `docs/architecture/decisions/0017-financial-fraud-ring-detection.md` | `tests/frontend/financial-fraud.test.mjs`, `tests/browser/pages.e2e.mjs` | Synthetic financial transaction workflow passes: required fields, mule/ring indicator ranking, infrastructure toggle, semantic mirror, neutral report preflight, Pages use-case switch, rotate/spin, undo, and layout reset. Advanced TGNN/GNN models remain gated pending leakage-safe evaluation and human-factor testing. |
| REQ-FR-028 import preview/mapping/rejected rows/provenance | `packages/guided-workflow/transaction-import.mjs`, `apps/web/app.mjs`, `apps/web/index.html` | `tests/frontend/transaction-import.test.mjs`, `tests/browser/pages.e2e.mjs` | CSV training import maps required fields, rejects invalid rows with reasons, creates an imported graph, runs imported fraud detection, and preserves parser/file/row provenance in reports. Production authorized ingestion remains future work. |
| Phase B chart authoring/search/path slice; BB-CHART-001–005 | `packages/graph-renderer/chart-workspace.mjs`, `apps/web/app.mjs`, `apps/web/index.html`, `docs/implementation/phase-b-storm-chart-workspace.md` | `tests/frontend/chart-workspace.test.mjs`, `tests/frontend/static-app.test.mjs`, `tests/browser/pages.e2e.mjs` | Search, pin, bounded expansion, visible-path finding, analyst annotations, saved/restored layouts, semantic workspace rows, and safety language pass in module/static/browser tests. Persistence, weighted paths, reducer undo/redo for pins/notes, and report-export semantics remain next iterations. |
