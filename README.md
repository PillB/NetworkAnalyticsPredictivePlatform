...
- [Phase B STORM chart workspace synthesis](docs/implementation/phase-b-storm-chart-workspace.md)
- [Competitor and user-value validation](docs/research/phase-b-competitor-user-validation.md)
