export const ONLINE_DATASET_SOURCES = Object.freeze([
  ...
  {
    id: "tgb-nodeprop-docs",
    name: "Temporal Graph Benchmark node prediction catalog",
    domain: "temporal graph benchmark",
    url: "https://tgb.complexdatalab.com/docs/nodeprop/",
    expectedUse: "adapter-catalog",
    sensitive: false,
    embeddable: false,
  },
  {
    id: "tgx-github",
    name: "TGX temporal graph exchange toolkit",
    domain: "temporal graph benchmark",
    url: "https://github.com/ComplexData-MILA/TGX",
    expectedUse: "adapter-tooling",
    sensitive: false,
    embeddable: false,
  },
  {
  ...
  {
    id: "elliptic2-paper",
    name: "Elliptic2 crypto graph benchmark paper",
    domain: "crypto transaction benchmark",
  ...
  {
    id: "paysim-paper",
    name: "PaySim mobile-money simulator paper",
    domain: "synthetic fraud benchmark",
    url: "https://www.researchgate.net/publication/265736405_PaySim_A_financial_mobile_money_simulator_for_fraud_detection",
    expectedUse: "source-citation",
    sensitive: false,
    embeddable: false,
  },
  {
    id: "dgraph-fin-paper",
    name: "DGraph-Fin financial graph benchmark",
    domain: "financial graph anomaly benchmark",
  ...
  {
    id: "gadbench-readme",
    name: "GADBench graph anomaly benchmark suite",
    domain: "graph anomaly detection benchmark",
    url: "https://raw.githubusercontent.com/squareRoot3/GADBench/main/README.md",
    expectedUse: "adapter-catalog",
    sensitive: false,
    embeddable: false,
  },
  {
    id: "networkrepository-crime",
    name: "Network Repository crime network catalog",
    domain: "criminology topology benchmark",
    url: "https://networkrepository.com/crime.php",
    expectedUse: "adapter-catalog",
    sensitive: true,
    embeddable: false,
  },
